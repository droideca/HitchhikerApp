...
//
//  Auto generated by swift-json-gen on Tue, 18 Aug 2015 12:42:15 GMT
//

import Foundation

extension SpasceShipInfo {
  static func decodeJson(json: AnyObject) -> SpasceShipInfo? {
    ...
    return SpasceShipInfo(id: id, pictureDriver: pictureDriver, nameDriver: nameDriver, specie: specie, planet: planet, pictureSpaceShip: pictureSpaceShip, typeSpaceShip: typeSpaceShip)
  }
